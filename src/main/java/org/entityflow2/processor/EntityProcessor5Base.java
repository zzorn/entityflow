 ...
 */
public abstract class EntityProcessor5Base<
     ...
     */
    protected EntityProcessor5Base(C1 componentType1, C2 componentType2, C3 componentType3, C4 componentType4, C5 componentType5) {
        this(componentType1, componentType2, componentType3, componentType4, componentType5, null);
    }
     ...
     */
    protected EntityProcessor5Base(C1 componentType1,
                                   C2 componentType2,
                                   C3 componentType3,
                                   C4 componentType4,
                                   C5 componentType5,
                                   UpdateStrategy updateStrategy) {
        super(updateStrategy, componentType1, componentType2, componentType3, componentType4, componentType5);
    ...
    @Override protected final void updateEntity(Time time, int entityId) {
        updateEntity(time, entityId, componentType1, componentType2, componentType3, componentType4, componentType5);
    }

    protected abstract void updateEntity(Time time, int entityId, C1 componentType1, C2 componentType2, C3 componentType3, C4 componentType4, C5 componentType5);
}
